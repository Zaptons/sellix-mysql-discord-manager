...
* Learning about how to manage mysql connections through discord.py
...
1. Clone the repo
   ```sh
   git clone https://github.com/Zaptons/sellix-mysql-discord-manager.git
   ```
3. Import through requirements.txt

4. Change details in the .env file
   ```python
   WHITELIST_IDS = [123123123123,123123411514] #? Place wanted whitelisted IDs in here as shown here
